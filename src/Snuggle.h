...
public:
    ...
    // Post: Updates Snuggladon's grid coordinates.
    ...
    // Pre: targetRow/Col must be valid; terrainMap and occupied must reflect arena.
    // Post: Updates Snuggladon's position following simple Euclidean pathfinding.
